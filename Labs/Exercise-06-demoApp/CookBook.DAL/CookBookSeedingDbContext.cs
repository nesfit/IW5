...
{
    public class CookBookSeedingDbContext : CookBookDbContext
    {
        ...
        static CookBookSeedingDbContext()
        {
            RecipeEntity.Ingredients = new[] {IngredientAmountEntity1, IngredientAmountEntity2};
        }
