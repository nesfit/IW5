...
namespace WebCalculator.Tests
{
    ...
    public class ApplicationTests
    {
        ...
        { 
            IWebElement firstField = this.browser.FindElement(By.Name("First"));
            firstField.SendKeys(50.ToString());
            IWebElement secondField = this.browser.FindElement(By.Name("Second"));
            secondField.SendKeys(20.ToString());
            IWebElement btnCalculate = this.browser.FindElement(By.Id("btnCalculate"));
            btnCalculate.Click();
