...
public partial interface IIngredientApiClient
{
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<System.Guid> UpsertAsync(string version, string culture, IngredientDetailModel ingredient);
    
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<System.Guid> UpsertAsync(string version, string culture, IngredientDetailModel ingredient, System.Threading.CancellationToken cancellationToken);
...
public partial class IngredientApiClient : IIngredientApiClient
{
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public System.Threading.Tasks.Task<System.Guid> UpsertAsync(string version, string culture, IngredientDetailModel ingredient)
    {
        return UpsertAsync(version, culture, ingredient, System.Threading.CancellationToken.None);
    }
    
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public async System.Threading.Tasks.Task<System.Guid> UpsertAsync(string version, string culture, IngredientDetailModel ingredient, System.Threading.CancellationToken cancellationToken)
    {
        if (ingredient == null)
            throw new System.ArgumentNullException("ingredient");
...
[System.CodeDom.Compiler.GeneratedCode("NSwag", "13.10.9.0 (NJsonSchema v10.4.1.0 (Newtonsoft.Json v11.0.0.0))")]
public partial interface ILoggingApiClient
{
    /// <exception cref="ApiException">A server side error occurred.</exception>
...
[System.CodeDom.Compiler.GeneratedCode("NSwag", "13.10.9.0 (NJsonSchema v10.4.1.0 (Newtonsoft.Json v11.0.0.0))")]
public partial class LoggingApiClient : ILoggingApiClient
{
    private string _baseUrl = "https://localhost:44378";
    private System.Net.Http.HttpClient _httpClient;
    private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
    public LoggingApiClient(System.Net.Http.HttpClient httpClient)
    {
        _httpClient = httpClient;
        _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings);
    }
...
public partial interface IRecipeApiClient
{
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<System.Guid> UpsertAsync(string version, string culture, RecipeDetailModel recipe);
    
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<System.Guid> UpsertAsync(string version, string culture, RecipeDetailModel recipe, System.Threading.CancellationToken cancellationToken);
...
public partial class RecipeApiClient : IRecipeApiClient
{
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public System.Threading.Tasks.Task<System.Guid> UpsertAsync(string version, string culture, RecipeDetailModel recipe)
    {
        return UpsertAsync(version, culture, recipe, System.Threading.CancellationToken.None);
    }
    
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public async System.Threading.Tasks.Task<System.Guid> UpsertAsync(string version, string culture, RecipeDetailModel recipe, System.Threading.CancellationToken cancellationToken)
    {
        if (recipe == null)
            throw new System.ArgumentNullException("recipe");
